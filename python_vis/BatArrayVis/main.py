...
def plotTheThings(filepath, numSamples, offset):
    channels = [[], [], [], [], [], [], [], []]
    time = []
    ...
    # plot channel 1
    plot.stem(time, channels[0], label="1KHz Sample")
    ax = plot.gca()
    ax.set_ylim(-7.5, 7.5)
    plot.show()
...
if __name__ == '__main__':
    plotTheThings("/Users/philbush/Bat Array Local/1khz_test.raw", 25000, 0x20000)
