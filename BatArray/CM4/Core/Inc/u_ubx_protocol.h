...
#define U_UBX_PROTOCOL_OVERHEAD_LENGTH_BYTES (U_UBX_PROTOCOL_HEADER_LENGTH_BYTES + 2)
   ...
   */
  int32_t uUbxProtocolEncode ( int32_t messageClass, int32_t messageId, const char *pMessageBody,
  ...
  int32_t uUbxProtocolDecode ( const char *pBufferIn, size_t bufferLengthBytes,
                               int32_t *pMessageClass, int32_t *pMessageId, char *pMessageBody,
                               size_t maxMessageBodyLengthBytes, const char **ppBufferOut );
